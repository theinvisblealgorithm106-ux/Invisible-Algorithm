...
export const researchApi = {
  ...
  initUpload: (data: { filename: string; fileSize: number; mimeType: string }) => api.post('/research/upload/session', data),
  completeUpload: (data: { title: string; name: string; driveFileId: string }) => api.post('/research/upload/complete', data),
