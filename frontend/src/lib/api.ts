...
export const researchApi = {
  ...
  initUpload: (data: { fileSize: number; mimeType: string }) => api.post('/research/upload/session', data),
  completeUpload: (data: { title: string; name: string; driveFilename: string }) => api.post('/research/upload/complete', data),
